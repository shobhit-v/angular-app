...
@Component({
  selector: 'app-weather-dispaly',
  templateUrl: './weather-dispaly.component.html',
  styleUrls: ['./weather-dispaly.component.css']
})
export class WeatherDispalyComponent implements OnInit {
